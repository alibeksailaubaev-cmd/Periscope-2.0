...
params = [
    ...
    ("Норма расхода рабочего раствора, л/м²", V_NORM, N3, True,
     "ДОПУЩЕНИЕ. Принята типовая норма влажной дезинфекции гладких поверхностей — 0,5 л/м². "
     "Замените на норму из инструкции по применению Фоснитацида — весь файл пересчитается. "
     "Варианты норм см. на листе «Сценарии норм расхода»."),
...
sc["A2"] = ("Норма расхода рабочего раствора на 1 м² — единственный параметр, не заданный в исходных данных. "
            "Ниже — потребность на одну обработку всех корпусов при типовых нормах.")
...
scen = [(0.15,"Ориентировочно соответствует текущей выдаче 1 канистры на корпус"),
        (0.20,"Аэрозольная / мелкокапельная обработка"),
        (0.25,"Аэрозольная обработка, усиленный режим"),
        (0.30,"Влажная дезинфекция, минимальный режим"),
        (0.50,"Влажная дезинфекция гладких поверхностей — принято в расчете"),
        (1.00,"Влажная дезинфекция шероховатых поверхностей / двукратная обработка")]
rr = hr + 1
