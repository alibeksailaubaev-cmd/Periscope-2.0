...
const TASKS = [
  ...
  { id: "int_vnd", name: "ВНД: внутренние требования ББ", icon: FileText, group: "reg", contour: "internal", hours: 4.5, cov: 0, freq: "проект", note: "Мониторинг требований, разработка и контроль исполнения СОП", isNew: true,
  ...
  { id: "int_husk", name: "Склады", icon: Layers, group: "daily", contour: "internal", hours: 4.0, cov: 70, freq: "еженедельно", note: "Санитарное состояние складов, условия хранения, дератизация и дезинсекция",
  ...
  { id: "int_entry", name: "Внутренний входной контроль", icon: DoorOpen, group: "crit", contour: "internal", hours: 5.5, cov: 0, freq: "ежедневно", note: "Контроль поступающих грузов, сырья и тары внутри контура", isNew: true,
  ...
  { id: "int_pest", name: "Внутренний пест-контроль", icon: Bug, group: "daily", contour: "internal", hours: 3.0, cov: 0, freq: "еженедельно", note: "Мониторинг и локальные обработки внутри контура", isNew: true,
...
function MindMap({ T, accent, hubTitle, hubSub, items, onItem }) {
  ...
  const PW = 306, PH = 80, GAP = 15, PAD = 34;
